...
public class IntHistogram implements Histogram<Integer> {
    ...
    public String toString() {
        return "IntHistogram{" + "maxVal=" + maxVal + ", minVal=" + minVal + ", heights=" + Arrays.toString(heights) + ", buckets=" + buckets + ", totalTuples=" + totalTuples + ", width=" + width + ", lastBucketWidth=" + lastBucketWidth + '}';
    }
}
